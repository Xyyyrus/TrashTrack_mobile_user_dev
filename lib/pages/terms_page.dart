...
import 'package:flutter/material.dart';
import 'package:trashtrack_user/widgets/custom_app_bar_term.dart';
...
class _TermsPageState extends State<TermsPage> {
  ...
  void _onUnderstandPressed() {
    ...
    // After the user presses "I Understand", pop and return true to indicate agreement
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const Text(
                'In no event shall the app or its owners be liable for any damages arising from the use of this app.',
                style: TextStyle(fontSize: 16),
              ),
              const SizedBox(height: 16),
              const Text(
                ...
                children: <Widget>[
                  Checkbox(
                    ...
                    onChanged: (bool? value) {
                      // Keep the checkbox unchecked until they click "I Understand"
                      setState(() {
              ...
              Center(
                child: ElevatedButton(
                  onPressed: _isChecked
                      ? _onUnderstandPressed
                      : null, // Enable only if the checkbox is checked
      ...
      //     onPressed: _isButtonEnabled ? _onUnderstoodPressed : null,
      //     backgroundColor: _isButtonEnabled ? Colors.blue : Colors.grey,
      //     label: const Text('I understood'),
